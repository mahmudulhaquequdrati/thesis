...
| **Next action** | **You (1):** read HRBench + Route-To-Reason and raise §15.3 with your advisor — this may change the framing. **You (2):** create an OpenRouter account, load ~$10, put the key in `.env`, run `uv run python scripts/day1_hello.py` |
