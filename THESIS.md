...
| 🟨 | 5 | RQ1–RQ3: Pareto frontier, convex hull, CPC/TPC with CIs | **CPC/TPC with bootstrap CIs ✅** (`carr/stats.py`, 10 tests). Pareto frontier + convex hull still ⬜ — needs `scipy` |
