...
| | |
|---|---|
| **Stage** | Week 1 — Days 1–2 ✅. Roster verified, problems loaded, data spec written. |
| **Next action** | **Day 3:** the Docker sandbox grader (free, no API). Then Day 4–5, then **the pilot** — which gates grid size. In parallel: [docs/advisor-repositioning.md](docs/advisor-repositioning.md) to your advisor |
