...
| | |
|---|---|
| **Stage** | Week 1 — Day 1 ✅ complete. Roster verified with real prices. |
| **Next action** | **Day 2:** load HumanEval+ problems. Then Days 3–5, then **the pilot** — which gates the grid size. In parallel: take [docs/advisor-repositioning.md](docs/advisor-repositioning.md) to your advisor |
| **Spend to date** | ~$0.001 of **$4.00 loaded** ($50 ceiling) |
| **Rows in dataset** | 0 of ~2,700 (300 problems × 9 configs — final count set by the pilot) |
